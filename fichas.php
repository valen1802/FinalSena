		        ...
		        <div class="panel panel-login">
		          <div class="panel-heading">
		            ...
		            <div class="row">
		              ...
		              <div class="col-xs-6">
		                <span class="glyphicon glyphicon-user" ></span> <a  href="#" id="register-form-link">Fichas</a>
                        <br><br>
                    ...
                    <tbody>
                        <tr>
                        <th scope="row">1</th>
                        <td>Tecnologo en construccion de infraestructura vial </td>
                        <td>1320665</td>
                        <td>Centro para el desarrollo tecnologico de la construccion y la industria</td>
                        </tr>
                        <tr>
                        <th scope="row">2</th>
                        <td>Certificacion en construcciones en seco sistema drywall</td>
                        <td>1320667</td>
                        <td>Centro para el desarrollo tecnologico de la construccion y la industria</td>
                        </tr>
                        <tr>
                        <th scope="row">3</th>
                        <td>Tecnologo en contruccion de estructura en concreto</td>
                        <td>1320578</td>
                        <td>Centro para el desarrollo tecnologico de la construccion y la industria</td>
                        </tr>
                    </tbody>
