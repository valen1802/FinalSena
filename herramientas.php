		      ...
		      <div class="col-md-6 col-md-offset-3">
		        <div class="panel panel-login">
		          <div class="panel-heading">
		            ...
		            <div class="row">
		              <div class="col-xs-6"> 
		                <span class="glyphicon glyphicon-floppy-save"></span><a href="#" class="active" id="login-form-link">Crea Herramientas</a>
						<br>
						<br>
						<img src="imagenes/crear.png" widht="100" height="100"> 
		              </div>
					  

	<div class="panel-body">
	 <form role="form" method="POST" action="crear_herramienta.php">
		            <div class="row">
		              <div class="col-lg-12">
		              <!-- comienza  el formulario el pattern se uza como un campo requerido -->
						...
						<div class="form-group">
		                  <div class="form-group">
		                    <input type="text" name="cod_herramienta" id="cod_herramienta" tabindex="2" class="form-control" placeholder="Codigo Herramienta" value="" >
		                  </div>
		                    <input type="text" name="nombre_herramienta" id="nombre_herramienta" tabindex="1" class="form-control" placeholder="Nombre Herramienta" value="" >
		                  </div>
						  <div class="form-group">
		                    <input type="text" name="cantidad_disponible" id="cantidad_disponible" tabindex="2" class="form-control" placeholder="Cantidad" value="">
		                  </div>
						  <div class="form-group">
		                    <input type="number" name="precio_herramienta" id="precio_herramienta" tabindex="2" class="form-control" placeholder="Precio Herramienta" value="" >
		                  </div>
		                  <div class="form-group">
		                    <input type="number" name="nivel" id="nivel" tabindex="2" class="form-control" placeholder="Nivel" value="">
		                  </div>
		                  <div class="form-group">
		                    <div class="row">
