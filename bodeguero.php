		      ...
		      <div class="col-md-6 col-md-offset-3">
		        <div class="panel panel-login">
		          <div class="panel-heading">
		            ...
		            <div class="row">
		              <div class="col-xs-6"> 
		                <span class="glyphicon glyphicon-ok-sign"></span><a href="#" class="active" id="login-form-link">Bodeguero</a>
						<br>
						<br>
						<img src="imagenes/bodeguero.png" widht="110" height="110"> 

						<h2>Bienvenido Bodeguero</h2>
		              </div>
