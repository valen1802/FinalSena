    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="archivo_registrar.php" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <div class="form-group">
              <label for="confirmarcla">Confirmar contraseña:</label>
              <input type="password" name="confirmarcla" class="form-control" id="confirmarcla" placeholder="Confirmar Contraseña" required>
            </div>
            <!-- <div class="form-group">
