		      ...
		      <div class="col-md-6 col-md-offset-3">
		        <div class="panel panel-login">
		          <div class="panel-heading">
		            ...
		            <div class="row">
		              <div class="col-xs-6"> 
		                <span class="glyphicon glyphicon-ok-sign"></span><a href="#" class="active" id="login-form-link"> Agregar Administrador</a>
						<br>
						<br>
						<img src="imagenes/add_admin.png" widht="110" height="110"> 
		              </div>
					  
								
	 <div class="panel-body">
	 <form role="form" method="POST" action="registrar_admin.php">
		            <div class="row">
		              <div class="col-lg-12">
		              <!-- comienza  el formulario el pattern se usa como un campo requerido -->
		                <form id="login-form" role="form" style="display: block;">
						<div class="form-group">
		                  <div class="form-group">
		                    <input type="text" name="nombre" id="nombre" tabindex="2" class="form-control" placeholder="Nombre" value="" >
		                  </div>
		                    <input type="number" name="cedula" id="cedula" tabindex="1" class="form-control" placeholder="Cedula" value="" >
		                  </div>
						  <div class="form-group">
		                    <input type="text" name="correo" id="correo" tabindex="2" class="form-control" placeholder="Correo" value="">
		                  </div>
						  <div class="form-group">
		                    <input type="number" name="celular" id="celular" tabindex="2" class="form-control" placeholder="Celular" value="" >
		                  </div>
		                  <div class="form-group">
		                    <input type="password" name="clave" id="password" tabindex="2" class="form-control" placeholder="Password" value="">
		                  </div>
						  <div class="form-group">
